...
namespace Hackathon.Boilerplate.Foundation.BusinessValueTracker.Workers
{
    public class RfmTrainingWorkerOptionsDictionary : DeferredWorkerOptionsDictionary
    {
        ...
        private const string TrainingWorkerOpenGenericTypeFormat = "Hackathon.Boilerplate.Foundation.BusinessValueTracker.Workers.RfmTrainingWorker, Hackathon.Boilerplate.Foundation.BusinessValueTracker";
        ...
        public string SchemaName
        {
            get
            {
                return this[nameof(SchemaName)];
            }
        }

        public IReadOnlyDictionary<string, string> ModelOptions
        {
            get
            {
                return GetOptionsWithoutReservedKeys(this);
            }
        }
        ...
        public IReadOnlyList<string> TableNames
        {
            get
            {
                return this.DeserializeJsonValue<IReadOnlyList<string>>(nameof(TableNames));
            }
        }
